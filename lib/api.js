 ...
 */
export async function fetchRecipes(page, limit, search, category, tags, steps, ingredients = [], topRated = false) {
  try {
    // Construct the URL
    ...
    if (ingredientsMatchType) url.searchParams.append("ingredientsMatchType", ingredientsMatchType); // Add ingredients match type
