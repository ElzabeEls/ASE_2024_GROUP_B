 ...
 *  @param {string} sort - The sorting option for ordering recipes (optional).
 ...
 */
export async function fetchRecipes(page, limit, search, category, tags, steps, sortBy, sortOrder) {
  try {
    // Construct the URL
