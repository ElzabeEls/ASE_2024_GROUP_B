 ...
 */
export async function fetchRecipes(page = 1, limit = 20, steps, search = "") {
  ...
  try {
    ...
    // Construct the URL with page, limit, and optionally steps query parameters
...
// If additional query parameters exist in queryString, append them
if (queryString) {
